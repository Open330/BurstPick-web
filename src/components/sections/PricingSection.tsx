        ...
        <div className="mx-auto grid max-w-4xl gap-8 lg:grid-cols-2">
          ...
          <FadeInView delay={0.2}>
            <div className="relative flex h-full flex-col rounded-xl border border-brand-start/30 bg-surface-secondary p-8 shadow-lg shadow-brand-start/5">
              ...
              <div className="mt-8 inline-flex w-full items-center justify-center gap-2 rounded-xl border border-white/20 bg-white/5 px-6 py-3 text-base font-semibold text-text-secondary cursor-default">

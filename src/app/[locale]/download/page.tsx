  ...
  return (
    <main className="px-0 pt-28 pb-20 sm:pt-32 sm:pb-24">
      <Container className="max-w-3xl text-center">
        ...
        {/* Mac App Store coming soon badge */}
        <div className="mb-6 flex flex-col items-center gap-4">
          <div className="inline-flex items-center gap-3 rounded-2xl border border-white/20 bg-white/5 px-6 py-3 text-text-secondary cursor-default">
            ...
            <div className="text-left">
              <div className="text-[10px] font-medium leading-none">{t("button")}</div>
              <div className="text-xl font-semibold leading-tight">Mac App Store</div>
            </div>
          </div>
          <p className="max-w-md text-sm text-text-secondary">{t("notify_prompt")}</p>
          <a
            href="/#download"
            className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-brand-start to-brand-end px-6 py-3 text-base font-semibold text-white transition-opacity hover:opacity-90"
          >
            {t("notify_cta")}
          </a>
        </div>

...
import { BASE_PATH, APP_STORE_URL } from "@/lib/constants";
      ...
      <Container className="max-w-3xl text-center">
        ...
        <div className="mb-6">
          <a
            ...
            className="inline-flex items-center gap-3 rounded-2xl bg-white px-6 py-3 text-black transition-opacity hover:opacity-90"
          >
            ...
            <div className="text-left">
              ...
              <div className="text-xl font-semibold leading-tight">{t("button")}</div>
            </div>
          </a>
        </div>
